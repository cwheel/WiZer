...
while (True):
  ...
  try:
    ...
    try:
      req = urllib2.Request("http://" + sys.argv[1] + "/node/report", urllib.urlencode({"networks" : json.dumps(networks), "key" : "ed054f15f0c6482eb8eb673fac9b17b91972f5d95b176c1f811419f36107"}))
